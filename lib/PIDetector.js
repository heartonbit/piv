...
detector.addRule({
	'name':"여권번호",
	'regex':/([d|m|o|r|s|D|M|O|R|S][0-9]{8}|((BS|CS|DG|EP|GB|GD|GG|GJ|GK|GN|GP|GS|GW|GW|GY|HD|IC|JB|JG|JJ|JN|JR|JU|KJ|KN|KR|KY|MP|NW|SC|SJ|SM|SQ|SR|TJ|TM|YP|YS){2}[0-9]{7}))/g
});

detector.addRule({
	'name':"계좌번호",
	'regex':/(?:[^(=|T|c|\+|\(|\/|\.|\+|\d)]|^)(?!(640-0000)|(799-)|(642-)|(3544-)|(2642-)|(118-)|(120-)|(050-)|(491-)|(940-)|(120-04)|(086-)|(753-)|(010-)|(1010-)|(100-010)|(886-))([0-9]{3})(([0-9]{3}-[0-9]{2}-[0-9]{6})|(-[0-9]{2}-[0-9]{8})|(-[0-9]{2}-[0-9]{6}-[0-9]{1})|(-[0-9]{2}-[0-9]{6})|(-[0-9]{3}-[0-9]{6})|(-[0-9]{4}-[0-9]{4}-[0-9]{2})|(-[0-9]{5}-[0-9]{3})|(-[0-9]{6}-[0-9]{5})|(-[0-9]{6}-[0-9]{2}-[0-9]{3})|(-[0-9]{6}-[0-9]{3}))(([^0-9])|$)/g
});
